...
const Auth = () => {
  ...
  const formSubmitHandler = async (event) => {
    ...
    if (!isLoggedIn) {
      sendRequest({
        url: "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyC9wPSRuUS2GTLr1XB7P-MenNJv0kqkCmA",
        method: "POST",
        body: {
          email: enteredEmail,
      ...
      sendRequest(
        {
          url: "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyC9wPSRuUS2GTLr1XB7P-MenNJv0kqkCmA",
          method: "POST",
          body: {
            email: enteredEmail,
            password: enteredPassword,
